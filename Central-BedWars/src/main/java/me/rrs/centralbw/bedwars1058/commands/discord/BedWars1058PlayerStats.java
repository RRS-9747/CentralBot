package me.rrs.centralbw.bedwars1058.commands.discord;
...
public class BedWars1058PlayerStats extends ListenerAdapter {
    ...
    final YamlDocument config = CentralBedWars.getConfiguration();
    ...
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        ...
        if (event.getName().equals(config.getString("Config.Command"))) {
            ...
            if (player.isOnline()){
                ...
                Map<String, Integer> stats = CentralBedWars.getDatabase().getStats(player.getName());
