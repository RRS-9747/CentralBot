package me.rrs.centralbw.bedwars1058.listeners;
...
public class PlayerLeave implements Listener {
    ...
    public void onPlayerLeave(PlayerQuitEvent event){
        ...
        CentralBedWars.getDatabase().updateStats(player.getName(), bedDestroyed, death, finalKills, finalDeath, totalPlayed, kills, loses, win, level, winStreak, bestWinStreak);
    }
