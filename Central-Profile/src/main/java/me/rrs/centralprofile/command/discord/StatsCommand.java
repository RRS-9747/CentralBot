package me.rrs.centralprofile.command.discord;
...
public class StatsCommand extends ListenerAdapter {
    ...
    final YamlDocument config = CentralProfile.getConfiguration();
    ...
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        ...
        if (event.getName().equals(config.getString("Bot.Command"))){
            ...
            Map<String, String> allPAPITitles = CentralProfile.getDatabase().getAllPAPITitles();
